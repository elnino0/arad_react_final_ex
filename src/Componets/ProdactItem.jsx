...
function ProdactItem({prodact, onUpdate }){
    ...
    const renderProdacts = (col,raw) => {
        return <div class="text-blue-500 font-bold"> {raw[col.key]}</div>;
    }

    return (<div class="text-black-400 font-bold border-double border-4 border-indigo-600">
        ...
        <button class="bg-blue-300 hover:bg-blue-500 text-white font-bold py-1 px-3 rounded-full" onClick={e => onUpdate(e,details)}>Save</button>
    </div>)
}
